  ...
  clusters: [
    {
      ...
      label: "user",
      color: "#89b4fa",
      nodeIds: ["pages/UserPage.tsx", "components/UserCard.tsx", "hooks/useUser.ts"],
    },
    {
      id: "auth",
      label: "auth",
      color: "#cba6f7",
      nodeIds: ["hooks/useAuth.ts", "context/AuthProvider.tsx"],
    },
    {
      id: "shared",
      label: "shared",
      color: "#94e2d5",
      nodeIds: ["components/Avatar.tsx", "api/client.ts", "store/theme.ts"],
    },
  ],
}
